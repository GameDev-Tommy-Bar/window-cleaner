...
### במשחק עליך להכנס לדמות המנקה ולהתמודד עם הקשיים של ניקוי חלונות בניינים גבוהים
### בנוסף עליך לצבור כסף על ידי ניקוי החלונות וכך לקנות שיפורים שעוזרים לך להתקדם במשחק
### לפעמים זה יכול להראות קשה אך אם נתקעים שווה לחזור לשלב הקודם כדי לצבור עוד נקודות כדי לשפר יכולות מסוימות
### אחד האויבים הכי גדולים של מנקי חלונות ועובדים בגובה הוא הקסדה, משום שלפעמים עובדים כאלה או אחרים שוכחים לשים אותה וזה דבר מציל חיים
### במשחק שלנו ניתן לראות שהשחקן בעת עלייה לגובה חובש את הקסדה מייד
### בנוסף אחד הדברים שכדי ללמוד להתחמק ממנו במשחק הוא הציפורים שמעטות את קצב ההתקדמות במשחק
